...
class Carrefour {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            printCashierStatus(minutesWorked, waitingLinePerCashier, itemsRemainingPerCashier, waitingLineCostumer,
                    zeroCostumersInLine, costumersAttended, totalItemsSold);

            scanner.nextLine();
        } while (minutesWorked < TOTAL_MINUTES_PER_DAY);

        printDailySummary(costumersAtTheEnd, zeroCostumersInLine, costumersAttended, totalItemsSold);
